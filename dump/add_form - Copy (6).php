    ...
    <!-- here message will be displayed -->
        ...
        <tbody>
		 <tr>          
			...
			<td colspan="2">
            <button type="submit" class="btn btn-primary" id="btnAdd" name="btnAdd" >
    		<span class="glyphicon glyphicon-plus"></span> 
			Add Record </button> 
            </td>	

            <td colspan="2">
            <button type="submit" class="btn btn-primary" id="btnDelete" name="btnDelete"  title="Delete the selected videos">
