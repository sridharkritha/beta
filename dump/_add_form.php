    ...
    <!-- here message will be displayed -->
        ...
        <tbody>
		 <tr>			
			...
			<td colspan="2">
			<button type="submit" class="btn btn-primary" name="btn-delete" title="Delete the selected videos">
    		<span class="glyphicon glyphicon-minus"></span> 
			Delete Record </button>
			</td>	

            <td colspan="2">
            <button type="submit" class="btn btn-info" name="btn-save" id="btn-save">
