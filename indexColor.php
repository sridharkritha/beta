...
<body>
    ...
    <!-- here message will be displayed -->
		...
		<tr id='addr0'>   
			...
			<!--
			<td><input type='text' name='colour[]' class='form-control' placeholder='gold' required></td>
			-->
			
			
			<td>
			<select name='colour[]' class="form-control input-small">
			<option value="#FF0000">Dft</option>
